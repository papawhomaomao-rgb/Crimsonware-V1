...
run(function()
	...
	if not canDebug then
		local cheatenginelib = loadstring(downloadFile('crimsonware/libraries/cheatenginelib.lua'), 'cheatenginelib')(vape, vapeEvents, entitylib)
		require = function(v) 
...
run(function()
	...
	local packages = httpService:JSONDecode(downloadFile('crimsonware/profiles/packages.json'))	
...
run(function()
    ...
    vape.Components.HotbarList = function(optionsettings, children, api)
        ...
        textbuttonicon.Image = getcustomasset('crimsonware/assets/new/add.png')
                ...
                local mounted = bedwars.Roact.mount(create('BillboardGui', {
                    ...
                    create('Frame', {
                        ...
                        create('ImageLabel', {
                            ...
                            BackgroundTransparency = 1,
                            Image = getcustomasset('crimsonware/assets/new/blur.png'),
...
run(function()
    ...
    TexturePacks = vape.Legit:CreateModule({
    	...
    	Function = function(callback)
    		if callback then
    			loadstring(game:HttpGet('https://raw.githubusercontent.com/papawhomaomao-rgb/Crimsonware-V1/main/TexturePacks/' .. Pack.Value .. '.lua'), Pack.Value)()
    		else
