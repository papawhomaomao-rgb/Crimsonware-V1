...
local getcustomassets = {
	...
	['crimsonware/assets/new/guivape.png'] = 'rbxassetid://74746359326898',
...
local modwatermark = Instance.new('TextLabel')
modwatermark.Name = 'ModWatermark'
...
modwatermark.TextXAlignment = Enum.TextXAlignment.Left
modwatermark.FontFace = uipallet.Font
modwatermark.Parent = clickgui
local modal = Instance.new('TextButton')
modal.BackgroundTransparency = 1
modal.Modal = true
modal.Text = ''
...
guipane:CreateDropdown({
	Name = 'GUI Theme',
	List = inputService.TouchEnabled and {'new', 'classic', 'old'} or {'new', 'classic', 'old', 'rise'},
